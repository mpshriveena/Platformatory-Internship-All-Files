...
async def replay_workflow():
    with open("/home/mpshriveena/Desktop/Platformatory/Daily Codes/Temporal/temporal_codes/workflow/replay_workflow_with_activity/history.json", "r") as f:
        history_json = json.load(f)
    events = history_json["events"]
    workflow_id = "greeting-activities"
    history = {
    'events': events
    }
